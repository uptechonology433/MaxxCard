...
class ProductionReportDAO extends Connection
{
    ...
    public function getProductionReportFilterFileTarjaDAO(ProductionReportModel $productionReportModel): array
    {
        ...
        desc_produto ,
         ...
         nome_arquivo_proc
        total_cartoes, status from view_max_card_producao_elo WHERE nome_arquivo_proc = :arquivo");
    ...
    public function getProductionReportFilterDateTarjaDAO(ProductionReportModel $productionReportModel): array
    {
        ...
        desc_produto ,
         ...
         to_char(dt_expedicao, 'DD/MM/YYYY') AS dt_expedicao,
         nome_arquivo_proc
        total_cartoes, status from view_max_card_producao_elo where dt_processamento BETWEEN :datainicial AND :datafinal ;");
    ...
    public function getProductionReportFilterShippingTarjaDAO(ProductionReportModel $productionReportModel): array
    {
        ...
        desc_produto ,
         ...
         to_char(dt_expedicao, 'DD/MM/YYYY') AS dt_expedicao,
         nome_arquivo_proc
        total_cartoes, status from view_max_card_producao_elo where dt_expedicao BETWEEN :expedicaoinicial AND :expedicaofinal ;");
    ...
    public function getProductionReportFilterDatesInGeneralTarjaDAO(ProductionReportModel $productionReportModel): array
    {
        ...
        desc_produto ,
         ...
         to_char(dt_expedicao, 'DD/MM/YYYY') AS dt_expedicao,
         nome_arquivo_proc
        total_cartoes, status from view_max_card_producao_elo where dt_expedicao BETWEEN :expedicaoinicial AND :expedicaofinal OR dt_processamento BETWEEN :datainicial AND :datafinal;");
    ...
    public function getProductionReportFilterFileChipDAO(ProductionReportModel $productionReportModel): array
    {
        ...
        desc_produto ,
         ...
         to_char(dt_expedicao, 'DD/MM/YYYY') AS dt_expedicao,
         nome_arquivo_proc
        total_cartoes, status , rastreio from view_max_card_producao_chip WHERE nome_arquivo_proc = :arquivo");
    ...
    public function getProductionReportFilterDateChipDAO(ProductionReportModel $productionReportModel): array
    {
        ...
        desc_produto ,
         ...
         to_char(dt_expedicao, 'DD/MM/YYYY') AS dt_expedicao,
         nome_arquivo_proc
        total_cartoes, status , rastreio from view_max_card_producao_chip where dt_processamento BETWEEN :datainicial AND :datafinal ;");
    ...
    public function getProductionReportFilterShippingChipDAO(ProductionReportModel $productionReportModel): array
    {
        ...
        desc_produto ,
         ...
         to_char(dt_expedicao, 'DD/MM/YYYY') AS dt_expedicao,
         nome_arquivo_proc
        total_cartoes, status , rastreio from view_max_card_producao_chip where dt_expedicao BETWEEN :expedicaoinicial AND :expedicaofinal ;");
    ...
    public function getProductionReportFilterDatesInGeneralChipDAO(ProductionReportModel $productionReportModel): array
    {
        ...
        desc_produto ,
         ...
         to_char(dt_expedicao, 'DD/MM/YYYY') AS dt_expedicao,
         nome_arquivo_proc
        total_cartoes, status , rastreio FROM view_max_card_producao_chip where dt_expedicao BETWEEN :expedicaoinicial AND :expedicaofinal OR dt_processamento BETWEEN :datainicial AND :datafinal;");
